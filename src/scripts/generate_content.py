...
# 高品質記事のための追加ガイドライン（2.5倍以上の充実した内容）
QUALITY_GUIDELINES = """
【高品質記事のための必須要件 - 徹底版】

■ 記事ボリューム要件（必須）
- **最低文字数: 10,000文字以上**（従来の2.5倍）
- H2見出し: 8-12個
- H3サブ見出し: 各H2に2-4個
...
6. 具体的な解決策・方法（詳細）- 1200-1500字
   - ステップバイステップの解説
   - 初心者向け・中級者向け・上級者向けに分類
   - 具体的なツールやリソースの紹介
...
**重要**: 従来の2.5倍以上のボリューム（10,000文字以上）で執筆すること

1. 導入（リード文）- 400-500字
   - 読者の課題や関心に具体的に共感を示す
   - この記事で得られる価値を3つ明確に伝える
   - 衝撃的な数値やファクトで注意を引く
   - 記事の構成を予告する

2. 本文（8-12セクション）- 各600-1000字
   - 各セクションで1つの明確なポイントを深掘り
   - 具体的なデータ、事例、専門家の見解を必ず含める
   - 抽象的な説明の後に必ず具体例を3つ以上示す
   - 「〇〇の調査によると」「△△の専門家は」と根拠を明記
   - 各セクションにH3サブ見出しを2-4個設ける
...
【品質チェックリスト（執筆後に確認）】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
□ 文字数: 10,000-14,000文字（従来の2.5倍以上）
□ H2見出し: 8-12個
□ H3サブ見出し: 合計20個以上
□ 絵文字を一切使用していないか
□ 具体的な数値・データを最低15箇所以上含めたか
□ 各主張に根拠（ソース）を明記したか
□ 成功事例を3つ以上、失敗事例を2つ以上含めたか
□ 読者が実践できる具体的なアクションを5つ以上示したか
□ 7日より古い情報を含めていないか
□ 専門用語は初出時に必ず説明したか
□ 各セクションに十分な内容（600-1000字）があるか
